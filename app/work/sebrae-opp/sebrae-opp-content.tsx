    ...
    story: {
      ...
      cards: [
        ...
        },
        {
          ...
          text: "As faixas de classificação ficam por indicador no MongoDB e são computadas no servidor — a régua muda sem deploy.",
        },
        {
          number: "03",
    ...
    features: {
      ...
      items: [
        ...
        },
        {
          ...
          text: "Um redator guiado em dez etapas — de identificação a governança — que transforma diagnóstico em proposta de projeto público, com rascunho salvo por município e exportação em PDF construída apenas com window.print.",
