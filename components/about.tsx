...
const COPY = {
  ...
  pt: {
    ...
    bio1: "Eu construo produtos de ponta a ponta. Nos meus últimos projetos, fui responsável por tudo: do primeiro protótipo no Figma ao frontend em React, o schema PostgreSQL por trás e o pipeline de CI/CD que coloca tudo em produção, com design, código e deploy como um trabalho contínuo.",
